...
const Dependence = () => {
  ...
  }, [tableRef.current, selectedRowIds.length]);
  ...
  return (
    <div className="ql-container-wrapper dependence-wrapper ql-container-wrapper-has-tab">
      <div className="ql-page-header" style={headerStyle}>
        <span className="ql-page-header-title">{intl.get('依赖管理')}</span>
